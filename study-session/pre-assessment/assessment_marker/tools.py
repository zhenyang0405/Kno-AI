"""
Assessment Marker Tools

Tools for retrieving user answers, questions, and saving assessment results.
"""
import psycopg2
import json
...
def retrieve_assessment_questions(assessment_id: int) -> str:
    """
    Retrieves all questions for an assessment with metadata for context.
